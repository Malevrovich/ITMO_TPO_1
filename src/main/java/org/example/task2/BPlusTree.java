...
public class BPlusTree {
    ...
    private void handleDeficiency(InternalNode in) {
        ...
        // Borrow:
            ...
            if (in.leftSibling == null || !in.leftSibling.isLendable()) {
                if (in.rightSibling != null && in.rightSibling.isLendable()) {
                ...
                // Merge:
                    ...
                    if (in.leftSibling == null || !in.leftSibling.isMergeable()) {
                        if (in.rightSibling != null && in.rightSibling.isMergeable()) {
                            sibling = in.rightSibling;
    ...
    public void delete(int key) {
        if (isEmpty()) {
            ...
            throw new IllegalArgumentException("Invalid Delete: The B+ tree is currently empty.");
        } else {
            ...
            if (dpIndex < 0) {
                ...
                throw new IllegalArgumentException("Invalid Delete: Key unable to be found.");
            } else {
